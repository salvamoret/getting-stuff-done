...
namespace {
	...
	class Todo extends \GSD\Providers\TodoFacade{
		/**
		 * A stupid method for testing
		 *
		 * @static 
		 */
		 public static function imATeapot(){
			//Method inherited from \GSD\Providers\TodoManager
			 \GSD\Providers\TodoManager::imATeapot();
		 }
		 ...
		 * @static 
		 */
		 public static function makeList($id, $title){
			//Method inherited from \GSD\Providers\TodoManager
			return \GSD\Providers\TodoManager::makeList($id, $title);
		 }
		 ...
		 * @static 
		 */
		 public static function allLists($archived = false){
			//Method inherited from \GSD\Providers\TodoManager
			return \GSD\Providers\TodoManager::allLists($archived);
		 }
		 ...
		 * @static 
		 */
		 public static function get($id, $archived = false){
			//Method inherited from \GSD\Providers\TodoManager
			return \GSD\Providers\TodoManager::get($id, $archived);
		 }
